...
public class Servicios {
    ...
    public Servicios(int codigoServicio, String fechaServicio, String tipoServicio, String horaServicio, String lugarServicio, String telefonoContacto, int codigoEmpresa){
